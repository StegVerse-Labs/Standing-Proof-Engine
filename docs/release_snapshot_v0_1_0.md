...
The workflow verifies individual samples, the sample manifest, the Commitment Candidate manifest, expected-result fixtures, expected corpus, JSON exports, reviewer report generation, and formalism tests.
...
```text
v0.2.0 -> live SDK-generated Commitment Candidate manifest binding
